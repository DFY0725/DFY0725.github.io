  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
      <div className="max-w-3xl mx-auto px-6 h-14 flex items-center justify-between">
        <Link
          href="/"
          className="text-sm font-bold tracking-widest text-[#111] hover:text-accent transition-colors"
        >
          DFY
        </Link>
        <div className="flex items-center gap-5 text-sm text-gray-500">
          <Link href="/#projects" className="hover:text-[#111] transition-colors">
            项目
          </Link>
          <Link href="/#about" className="hover:text-[#111] transition-colors">
            关于
          </Link>
          <a
